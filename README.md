...
I'm a **final-year IT student @ Viswajyothi College of Engineering & Technology** — a **full-stack engineer** obsessed with **AI agents, real-time systems & cloud scale**.

I don't just build apps. I build **autonomous pipelines** that think, rank, and ship.
...
- 🤖 **Agents:** LangGraph, 8-agent orchestration, LLM ranking, SSE streaming
- 🏗️ **Stack:** React • Next.js • Flutter • Node.js • Python
- ☁️ **Cloud:** AWS EC2/S3/IAM/CloudWatch + Docker + K8s
- ⚡ **Realtime:** WebSockets, sub-200ms telemetry, zero third-party cloud
- 🔧 **Automation:** n8n, Gmail/WhatsApp/Calendar APIs, 5+ hrs/week saved

> **Open to:** Full-stack / AI / Backend roles • Startup collaborations • Freelance bangers
...
### Languages
<img src="https://skillicons.dev/icons?i=python,js,ts,dart,html,css,nodejs&theme=dark" />

### Frontend & Mobile
<img src="https://skillicons.dev/icons?i=react,nextjs,flutter,tailwind,bootstrap&theme=dark" />

### Backend • Database • Cloud
<img src="https://skillicons.dev/icons?i=express,postgres,mysql,mongodb,firebase,sqlite,aws,docker,kubernetes,git&theme=dark" />
...
- **5 concurrent analyzers** → ranked results in **15–20s**
- **100+ SSE streaming events** per search with adaptive confidence (3 LLM calls)
- LangGraph orchestration + real-time monitoring + error recovery
- Deployed on AWS with CloudWatch, IAM least-privilege

<sub>`LangGraph • LLM APIs • Node.js • React • AWS • SSE`</sub>
...
- `parse → plan → generate → validate` with **self-correction loops**
- **Zero manual scaffolding** via intelligent codegen
- Semantic validation for quality + compatibility
- Hours → seconds — dev friction eliminated

<sub>`LangGraph • LLM • JavaScript • React`</sub>
...
- **Gmail API** + **WhatsApp API** + **Google Calendar** + LLM smart replies
- Robust retry logic → **zero data loss** over weeks unattended
- Structured error logging, recovery, and self-healing
- Production n8n workflows at scale

<sub>`n8n • Gmail API • WhatsApp API • LLMs • Calendar API`</sub>
...
- Live CPU/RAM/Network via **WebSockets** + optimized serialization
- **Remote command execution** — zero third-party cloud, on-device privacy
- Native iOS & Android, beautiful Flutter UX

<sub>`Python • Flutter • WebSockets • AWS`</sub>
...
**AWS Intern — Cydez Technologies** &nbsp; `2024`
<br>
<sub>Provisioned **EC2 + S3** infra with Python & Bash automation • Cut deploy time **20%** • IAM least-privilege roles + CloudWatch dashboards • **99.9% uptime** with alerting</sub>
...
<picture>
  ...
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/vivek123r/vivek123r/output/github-contribution-grid-snake.svg">
  <img alt="snake eating contributions" src="https://raw.githubusercontent.com/vivek123r/vivek123r/output/github-contribution-grid-snake.svg">
</picture>
...
<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Hammer%20and%20Wrench.png" width="42"/><br>
<sub><b>Realtime Full-Stack</b></sub><br>
<sub>Scalable apps with SSE + WebSockets</sub>

</td>
<td align="center" width="25%">

<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Travel%20and%20places/Cloud.png" width="42"/><br>
<sub><b>Cloud-Native</b></sub><br>
<sub>Serverless & K8s patterns on AWS</sub>

</td>
<td align="center" width="25%">

<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Mobile%20Phone.png" width="42"/><br>
<sub><b>Flutter Cross-Platform</b></sub><br>
<sub>iOS & Android from one codebase</sub>
